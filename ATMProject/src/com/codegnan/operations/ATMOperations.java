...
//	validate user creadintials including PIN.
	public static IATMService validCreadintials(long cardNumber, int pinNumber)
...
//	validate the amount for Withdrawl to ensure sufficient machine balance
	...
	public static void main(String[] args) throws NotAOperatorException {
		dataBase.put(22222222221l, new AxisDebitCard(22222222221l,"Mallesh",50000.0,2222));
		dataBase.put(33333333331l, new SBIDebitCard(33333333331l,"Nagesh",25000.0,3333));
		dataBase.put(44444444441l, new HDFCDebitCard(44444444441l,"Guna",35000.0,4444));
		...
		while(MACHINE_ON) {
			...
			System.out.println("=============================================================================");
			System.out.println("==================Thanks For Using ICICI Bank ATM Machine=====================");
			System.out.println("=============================================================================");
		}
